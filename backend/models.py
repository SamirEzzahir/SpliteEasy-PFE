...
class Notification(Base):
    ...
    type: Mapped[str] = mapped_column(String(50), default="info") # expense, group, friend, system
    link: Mapped[str | None] = mapped_column(String(255), nullable=True) # e.g. /groups.html?id=1
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
