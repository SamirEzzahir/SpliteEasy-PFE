...
const en: OnboardingStrings = {
  ...
  intro: "SplitEasy keeps track of who owes who. Here's how to get started in 5 quick steps:",
  step1Title: "Add friends", step1Desc: "Connect with the people you share expenses with.",
  step2Title: "Create a group", step2Desc: "Start a group for a trip, home, or any shared spending.",
  step3Title: "Add members", step3Desc: "Invite the friends you share expenses with.",
  step4Title: "Add an expense", step4Desc: "Log what was paid and split it between members.",
  step5Title: "Settle up", step5Desc: "See who owes what and settle the balance in one tap.",
...
const fr: OnboardingStrings = {
  ...
  intro: "SplitEasy suit qui doit quoi à qui. Voici comment démarrer en 5 étapes :",
  step1Title: "Ajouter des amis", step1Desc: "Connectez-vous avec les personnes avec qui vous partagez les dépenses.",
  step2Title: "Créer un groupe", step2Desc: "Créez un groupe pour un voyage, la maison, ou toute dépense partagée.",
  step3Title: "Ajouter des membres", step3Desc: "Invitez les amis avec qui vous partagez les dépenses.",
  step4Title: "Ajouter une dépense", step4Desc: "Enregistrez ce qui a été payé et répartissez-le entre les membres.",
  step5Title: "Régler les comptes", step5Desc: "Voyez qui doit quoi et réglez le solde en un clic.",
...
const ar: OnboardingStrings = {
  ...
  intro: "يتتبع SplitEasy من يدين لمن. إليك كيف تبدأ في 5 خطوات سريعة:",
  step1Title: "أضف أصدقاء", step1Desc: "تواصل مع الأشخاص الذين تتقاسم معهم المصاريف.",
  step2Title: "أنشئ مجموعة", step2Desc: "ابدأ مجموعة لرحلة أو المنزل أو أي مصاريف مشتركة.",
  step3Title: "أضف أعضاء", step3Desc: "ادعُ الأصدقاء الذين تتقاسم معهم المصاريف.",
  step4Title: "أضف مصروفًا", step4Desc: "سجّل ما تم دفعه وقسّمه بين الأعضاء.",
  step5Title: "سوّ الحساب", step5Desc: "اعرف من يدين بماذا وسوِّ الرصيد بنقرة واحدة.",
...
const es: OnboardingStrings = {
  ...
  intro: "SplitEasy lleva la cuenta de quién debe a quién. Empieza en 5 pasos rápidos:",
  step1Title: "Añade amigos", step1Desc: "Conéctate con las personas con quienes compartes gastos.",
  step2Title: "Crea un grupo", step2Desc: "Crea un grupo para un viaje, el hogar o cualquier gasto compartido.",
  step3Title: "Añade miembros", step3Desc: "Invita a los amigos con quienes compartes gastos.",
  step4Title: "Añade un gasto", step4Desc: "Registra lo pagado y divídelo entre los miembros.",
  step5Title: "Salda cuentas", step5Desc: "Mira quién debe qué y salda el saldo con un toque.",
...
const de: OnboardingStrings = {
  ...
  intro: "SplitEasy verfolgt, wer wem was schuldet. So startest du in 5 schnellen Schritten:",
  step1Title: "Freunde hinzufügen", step1Desc: "Verbinde dich mit den Personen, mit denen du Ausgaben teilst.",
  step2Title: "Gruppe erstellen", step2Desc: "Starte eine Gruppe für eine Reise, Zuhause oder geteilte Ausgaben.",
  step3Title: "Mitglieder hinzufügen", step3Desc: "Lade die Freunde ein, mit denen du Ausgaben teilst.",
  step4Title: "Ausgabe hinzufügen", step4Desc: "Erfasse das Bezahlte und teile es unter den Mitgliedern auf.",
  step5Title: "Abrechnen", step5Desc: "Sieh, wer was schuldet, und gleiche den Saldo mit einem Tippen aus.",
