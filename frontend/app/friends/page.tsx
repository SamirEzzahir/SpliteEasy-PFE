                ...
                return (
                  <div key={f.personId} className="friend-row">
                    ...
                    {tab === "friend" ? (
                      <div className="friend-actions">
                        {f.balance === 0 ? (
                          <div className="friend-bal settled">
                            <div className="lbl">Settled up</div>
                        ...
                        <button className="btn-chat" title="Message"><Icon name="chat" size={15} /></button>
                        <button
                      ...
                      <div className="friend-actions">
                        <div className="friend-req-time">Sent {f.requestAt}</div>
                        ...
                        <button className="btn-more-i" title="More"><Icon name="dots" size={15} /></button>
                      </div>
                    ) : (
                      <div className="friend-actions">
                        <div className="friend-req-time">Sent {f.requestAt}</div>
