...
const NAV: NavItem[] = [
  ...
  { id: "jars",        label: "Econome (Jars)", icon: "jars",      href: "/jars" },
  { id: "debts",       label: "Debts & Loans",  icon: "debt",      href: "/debts" },
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sb-bottom">
        <Link href="/account" className="sb-profile" style={{ textDecoration: "none", color: "inherit" }}>
